% get the hyper parameters - learning rate, iteration and regularized
...
% test classification comparison by regularization weight
...
% Test Error Rate with hyper parameter : 10 trial
num_runs = 10;
